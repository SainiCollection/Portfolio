              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                    <Typography variant="body1" sx={{ fontWeight: 500, minWidth: 80 }}>Phone:</Typography>
                    <Typography variant="body1">{cvData.phone}</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                    <Typography variant="body1" sx={{ fontWeight: 500, minWidth: 80 }}>Email:</Typography>
                    <Typography variant="body1">{cvData.email}</Typography>
                  </Box>
                </Grid>
                <Grid item xs={6}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                    <Typography variant="body1" sx={{ fontWeight: 500, minWidth: 80 }}>Location:</Typography>
                    <Typography variant="body1">{cvData.city}, {cvData.country}</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                    <Typography variant="body1" sx={{ fontWeight: 500, minWidth: 80 }}>Portfolio:</Typography>
                    <Typography variant="body1">{cvData.socialLinks[2].url}</Typography>
                  </Box>
                </Grid>
              </Grid>
            </Box>
