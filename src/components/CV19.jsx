...
const CVTemplate = () => {
  ...
  const cvData = {
    ...
    skills: [
      "React.js", "JavaScript (ES6+)", "TypeScript", "Redux", "Material-UI", 
      "CSS3/SCSS", "Responsive Design", "GraphQL", "Jest", "Node.js",
      "Git", "CI/CD", "Webpack", "AWS", "Agile Methodologies"
    ],
    experience: [
      {
    ...
    awards: [
      "1st Place - National Web Development Competition 2017",
      "Best UI Design - TechCrunch Hackathon 2018"
    ]
  };
        ...
        >
              ...
              <Section>
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap' }}>
                  {cvData.skills.map((skill, index) => (
                    <SkillBadge key={index} elevation={0}>
                      {skill}
                    </SkillBadge>
                  ))}
                </Box>
          ...
          <Section sx={{ mt: 2 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={6}>
                <Typography variant="h3" sx={{ mb: 1 }}>Achievements</Typography>
                <Box component="ul" sx={{ pl: 2 }}>
              ...
              <Grid item xs={6}>
                <Typography variant="h3" sx={{ mb: 1 }}>Awards</Typography>
                <Box component="ul" sx={{ pl: 2 }}>
